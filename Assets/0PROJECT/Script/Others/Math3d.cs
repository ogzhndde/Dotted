...
public class Math3d
{
	...
	public static bool LineLineIntersection(out Vector3 intersection, Vector3 linePoint1, Vector3 linePoint2, Vector3 lineVec1, Vector3 lineVec2)
	{
	...
	public static bool AreLinesIntersecting(out Vector3 intersection, Vector3 p1, Vector3 p2, Vector3 p3, Vector3 p4)
	{
		...
		// Check if the segments straddle the line
